...
##############################################################################
def var4d(x0,t,tobs,anawin,y,H,B,R,model,N,xtol_in):
    ...
    for j in range(int(totana)):
        ...
        xa0 = one4dvar(tstep_truth,o2t,anawin,xb0,yaux,H,B,R,model,N,xtol_in)
...
def one4dvar(tstep_truth,o2t,anawin,x0b,y,H,B,R,model,N,xtol_in):
    ...
    if opcmin=='dirmin':
        ...
        xa = fsolve(gradJ,x0b,xtol=xtol_in)#1e-6
